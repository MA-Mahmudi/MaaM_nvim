return {
  ...
  config = function()
    ...
    keymap.set("n", "<leader>hw", function() harpoon.ui:toggle_quick_menu(harpoon:list()) end)
    keymap.set("n", "<leader>he", function() harpoon:list():remove() end)
    ...
    keymap.set("n", "<leader>hg", function() harpoon:list():select(5) end)
    keymap.set("n", "<leader>hh", function() harpoon:list():select(6) end)
  end
}
